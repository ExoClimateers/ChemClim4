...
c             CPO2 = 8.27 + 2.58E-4*TF(J) - 1.877E5/TF(J)/TF(J)
c SR MacGregor: Sid's heat capacities
         	CPCO2 = 4.99 + 1.53E-2*TF(J) - 7.66E-6*TF(J)*TF(J)
        	CPN2 = 7.04 - 6.72E-4*TF(J) + 1.38E-6*TF(J)*TF(J)
        	CPO2 = 7.11 - 1.76E-3*TF(J) + 4.93E-6*TF(J)*TF(J)
