...
c S. MacGregor: Sid's heat capacities
	CPCO2 = 4.99 + 1.53E-2*T - 7.66E-6*T*T
      	CPN2 = 7.04 - 6.72E-4*T + 1.38E-6*T*T
      	CPO2 = 7.11 - 1.76E-3*T + 4.93E-6*T*T 
...
C
C Dry adiabat
c SR bug fix from Ray Pierrehumbert
c  40  DLPDLT = CPN*AMN/4.184*R
  40  DLPDLT = CPN/R
