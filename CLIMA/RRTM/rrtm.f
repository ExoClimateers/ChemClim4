...
c A. Zsom: all MXLAY=203 has been changed to MXLAY=603, 
c	all MXFSC=200 has been changed to MXFSC=297.
c	these changes are necessary if more than 200 layers are to be modeled in the climate code
c	with the current values, a maximum of 300 layers can be modeled.
