...
height=40.          # height of the atmosphere [km]. requires some experimenting
...
# planet parameters:
G=1697.             # the value of gravity
R0=1.7               # planet radius
P0=10.               # pressure at the surface
