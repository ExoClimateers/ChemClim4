        ...
        subroutine atm_chem(FLUXFAC,ICOUPLE,TSTOP,DT,NSTEPS,TIME)
...
***** READ THE PLANET PARAMETER DATAFILE *****
      READ(66,502) G,RPLANET,PRESURF,ALB,DELZ,ZTROP,JTROP
 502  FORMAT(F6.1/,F5.2/,F4.1/,F5.3/,E6.1/,E6.1/,I2)
      close(66)
C
C-AP
...
c- Chlorine compounds
        IF(I.EQ.LCLONO2)GOTO 26
c        IF(I.EQ.LHCL) GOTO 26
        IF(I.EQ.LCL) GOTO 26
c	IF(I.EQ.LHOCL) GOTO 26
        IF(I.EQ.LCLO) GOTO 26
	IF(I.EQ.LCH3CL) GOTO 26
...
c	IF(I.EQ.LCH3OOH) GOTO 26
	IF(I.EQ.LH2CO) GOTO 26
        IF(I.EQ.LCH3O2) GOTO 26	
