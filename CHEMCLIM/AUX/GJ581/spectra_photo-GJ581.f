...
C  Open the necessary datafiles
      ...
      open(unit=2,file='model3200-0.20AU_scaled-ph.pdat')
      open(unit=3, file='model3200-0.20AU_photo.pdat')
c File with the far uv for the photochemical model
      open(unit=4, file='faruv_model3200-0.20AU.pdat') 
