...
c   nskip is the number of lines to skip in the flux data file
      parameter(NF=1123, nskip=1, nL=108, nl2=10)
...
C  Open the necessary datafiles
      ...
      open(unit=2, file='model3650_scaled-ph.pdat', status='unknown')
      open(unit=3, file='model3650_photo.pdat', status='unknown')
c File with the far uv for the photochemical model
      open(unit=4, file='faruv_model3650.pdat') 
...
c For model stars the Lyman alpha flux at the stellar surface is 1e6 erg/cm2/s
c Scaling  this values we get 
c   3200: 2.06e-3
c   3400: 1.55e-3
c   3650: 1.15e-3
       xLy = 1.15e-3     !erg/cm^2/s
C Constants in cgs
      h = 6.625e-27
      c= 3.e10
