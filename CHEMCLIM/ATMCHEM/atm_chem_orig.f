...
c gicing initial conditions for NCOUPLE.eq.1
	...
	if ((NCOUPLE.EQ.1).AND.(ICOUPLE.EQ.1)) then
...
c         SGFLUX(14) = 1.131E9
c         SGFLUX(23) = 4.117E8
c SR MacGregor New fluxes with 300 layers, 0.2 albedo, tsurf=288.98
         SGFLUX(9) = -3.32E9     
         SGFLUX(10) = 1.31e11
c         SGFLUX(10) = 4.e9 abio flux used in Segura 2005
c         SGFLUX(10) = 6.8e8
         SGFLUX(11) = 2.30E11
         SGFLUX(14) = 6.75E8
         SGFLUX(23) = 3.31E8
...
c      IF((I.EQ.LH2S).AND.(Z(J).GT.1.2E6)) GOTO 26
c      IF((I.EQ.LHS).AND.(Z(J).GT.1.2E6)) GOTO 26
c      IF((I.EQ.LHSO).AND.(Z(J).GT.2.E6)) GOTO 26
c      IF((I.EQ.LCH3CL).AND.(Z(J).GT.2.8E6)) GOTO 26
c      IF((I.EQ.LH).AND.(Z(J).LT.3.E6)) GOTO 26
c      IF (I.EQ.LSO) GOTO 26
c      IF (I.EQ.LCL2O2) GOTO 26
c For AD Leo
c      IF(I.EQ.LH2) GOTO 26
C-KK	Added for low-O2 environments
c- Chlorine compounds
c        IF(I.EQ.LCLONO2)GOTO 26
c        IF(I.EQ.LHCL) GOTO 26
c        IF(I.EQ.LCL) GOTO 26
c	IF(I.EQ.LHOCL) GOTO 26
c        IF(I.EQ.LCLO) GOTO 26
...
C- Sulfur
c
c      IF(I.EQ.LH2SO4) GOTO 26
c	IF(I.EQ.LHSO) GOTO 26
c       IF(I.EQ.LSO2) GOTO 26
c	IF(I.EQ.LH2S) GOTO 26
c	IF(I.EQ.LHS) GOTO 26
c- Nitrogen
c       IF(I.EQ.LN2O5) GOTO 26
c       IF(I.EQ.LHNO2) GOTO 26
c	IF(I.EQ.LNO2) GOTO 26
c        IF(I.EQ.LHO2NO2) GOTO 26
c        IF(I.EQ.LNO3) GOTO 26
c        IF(I.EQ.LHNO3) GOTO 26
c	IF(I.EQ.LNO) GOTO 26
