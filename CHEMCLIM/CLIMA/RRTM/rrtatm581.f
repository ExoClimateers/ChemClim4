C     path:      $Source: /storm/rc1/cvsroot/rc/rrtm_lw/src/rrtatm.f,v $
C     author:    $Author: jdelamer $
C     revision:  $Revision: 5.14 $
...
C                                                                        FA00490
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA00500
...
C                                                                        FA00970
c      CHARACTER*8      HDATE,HTIME                                      &FA00980
C                                                                        FA00990
...
C                                                                        FA01130
      ...
      IBDIM = MXFSC                                                      FA01180
C                                                                        FA01190
c     CALL LBLDAT(HDATE)                                                 FA01200
c     CALL FTIME (HTIME)                                                 FA01210
c     WRITE (IPR,900) HDATE,HTIME                                        FA01220
C                                                                        FA01230
...
C**********************************************************************  FA03310
C                                                                        FA03320
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA03330
...
C     *****************************************************************  FA11780
C                                                                        FA11790
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA11800
...
C     *****************************************************************  FA12570
C                                                                        FA12580
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA12590
...
C     *****************************************************************  FA23580
C                                                                        FA23590
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA23600
...
C     *****************************************************************  FA24670
C                                                                        FA24680
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA24690
...
C                                                                        FA25480
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA25490
...
C                                                                        FA26570
C                                                                        FA26580
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA26590
...
C     *****************************************************************  FA28520
C                                                                        FA28530
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA28540
...
C***************************************************************         FA30240
C                                                                        FA30250
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA30260
...
C**********************************************************************  FA31220
C                                                                        FA31230
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA31240
...
C     *****************************************************************  FA34820
C                                                                        FA34830
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA34840
...
C     *****************************************************************  FA37790
C                                                                        FA37800
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA37810
...
C     *****************************************************************  FA38900
C                                                                        FA38910
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA38920
...
C     *****************************************************************  FA40550
C                                                                        FA40560
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA40570
...
C     *****************************************************************  FA42360
C                                                                        FA42370
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA42380
...
C     *****************************************************************  FA44590
C                                                                        FA44600
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA44610
...
C     *****************************************************************  FA46430
C                                                                        FA46440
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA46450
...
c                                                                               
      ...
      Real*8               SECANT,       XALTZ                                  
C                                                                               
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FA47000
...
C     *****************************************************************         
C                                                                               
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                           
...
C    *****************************************************************   FX00130
C                                                                        FX00140
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FX00150
...
C     *****************************************************************  FX03530
C                                                                        FX03540
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FX03550
...
C     *****************************************************************  FX05100
C                                                                        FX05110
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FX05120
...
C     *****************************************************************  FX05670
C                                                                        FX05680
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FX05690
...
C                                                                        FX06770
      PARAMETER (MXFSC=600, MXLAY=MXFSC+3,MXZMD=3400,                    FX06780
...
C CALCULATE GRAVITY AT REFERENCE LATITUDE AT SURFACE                            
      ...
      G0 = 16.7 - 0.02586*COS(2.0*PI*REF_LAT/180.0)                          
