...
# path to directories
IO_path="/home/rugheimer/CHEMCLIM1/CHEMCLIM/IO/"
NZ_path="/home/rugheimer/CHEMCLIM1/CHEMCLIM/ATMCHEM/INCLUDECHEM/"
ND_path="/home/rugheimer/CHEMCLIM1/CHEMCLIM/CLIMA/INCLUDECLIM/"
...
# couple.f parameters:
NITER=30    # number of total iterations
NSTEPSC=300 # number of times the climate code is called
NSTEPSP=400 # number of times the photochemistry is called 

#clima code parameters:
Ptop=[3.e-5]                          # pressure at the top in bar
#Ptop for F0,   F2,   F5,    F7,    F9,    G2,   SUN   F8,  K0,   K2,   K4,   K5,   K7 at 65km
#Ptop=[4.e-4, 3.5e-4, 3.e-4, 3.e-4, 2.e-4, 1.e-4, 1e-4]#,8.e-5,7.e-5,8.e-5,6.e-5,3.5e-5,3.e-5]
#Ptop=[6.e-5,3.5e-5,3.e-5]
ND=[200]
